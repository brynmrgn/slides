---
title: "Publication tool proof of concept"
date: "25 March 2026"
...
## {background-image="../images/raychel-sanner-1cJXplTxrmI-unsplash.jpg" background-size="cover"}
...
<p class="fragment">More problems? Add to the chat.</p>
</div>
...
::: notes
To produce PDFs, we need more than just content — we need author, images, dates, etc.
:::

---

## Demo {.feature background-color="#FDE2CF"}
...
## Any thoughts? {.feature background-color="#FDE2CF"}
